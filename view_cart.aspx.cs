...
namespace Food_Order_System.Website
{
    public partial class cart : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            dt.Columns.AddRange(new DataColumn[5] { new DataColumn("Item_Name"), new DataColumn("Rate"), new DataColumn("Discount"), new DataColumn("Image"), new DataColumn("Quantity") });
        ...
        //{
        //    DataTable dt = new DataTable();
        //    dt.Columns.AddRange(new DataColumn[4] { new DataColumn("Item_Name"), new DataColumn("Rate"), new DataColumn("Discount"), new DataColumn("Image") });
        //    if (Request.Cookies["aa"] != null)
        //    {
        //        s = Convert.ToString(Request.Cookies["aa"].Value);
        //        string[] strArr = s.Split('|');
